  ...
  return (
    <div className="min-h-screen pb-40 bg-slate-950 text-slate-50 flex flex-col font-sans">
      ...
      <main className="max-w-7xl mx-auto w-full p-4 md:p-8 flex-grow">
        <section className="mb-12 rounded-[2rem] overflow-hidden relative min-h-[300px] md:min-h-[400px] flex items-end p-6 md:p-12 shadow-2xl border border-white/5">
        ...
        <section className="mb-20">
          ...
          {/* CRITICAL CHANGE: Always 2 columns for all screens */}
      ...
      <footer className="py-20 border-t border-white/5 flex flex-col items-center gap-6">
        ...
        <p className="text-slate-700 text-[9px] font-black tracking-[0.4em] uppercase">Private Corporate Distribution</p>
        <button 
      ...
      {showLoginModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-950/98 backdrop-blur-2xl p-4">
          <div className="bg-slate-900 border border-white/10 p-10 rounded-[3rem] w-full max-w-sm shadow-2xl relative overflow-hidden">
            ...
            <h3 className="text-lg font-black mb-8 text-center tracking-widest uppercase">Management Access</h3>
            <form onSubmit={handleAdminLogin} className="space-y-6">
              ...
              <div className="flex flex-col gap-3">
                <button type="submit" className="w-full bg-white text-black font-black py-4 rounded-2xl uppercase text-[10px] tracking-widest hover:bg-amber-500 transition-all">Authorize</button>
