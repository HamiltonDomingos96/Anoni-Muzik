          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 animate-in slide-in-from-bottom-4 duration-500">
            ...
            <section className="bg-slate-900 p-8 rounded-[2.5rem] border border-white/5 shadow-2xl space-y-8">
              ...
              <div className="space-y-6">
                ...
                {/* EDIÇÃO DO BOTÃO HERO */}
                <div className="p-6 bg-black/40 rounded-3xl border border-white/5 space-y-6">
                  <h4 className="text-[10px] font-black uppercase text-amber-500 tracking-widest">Configuração do Botão da Capa</h4>
                  <div className="space-y-2"><label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Texto do Botão</label><input type="text" value={settings.heroButtonText} onChange={e => setSettings({...settings, heroButtonText: e.target.value})} className="w-full bg-black border border-white/10 p-4 rounded-xl outline-none text-sm text-white" /></div>
                  <div className="space-y-2"><label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Link (WhatsApp ou Outro)</label><input type="text" value={settings.heroButtonUrl} onChange={e => setSettings({...settings, heroButtonUrl: e.target.value})} className="w-full bg-black border border-white/10 p-4 rounded-xl outline-none text-sm text-white" /></div>
                  <div className="space-y-2"><label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1">Cor do Botão</label><div className="flex gap-4 items-center bg-black/40 p-3 rounded-2xl border border-white/5"><input type="color" value={settings.heroButtonColor} onChange={e => setSettings({...settings, heroButtonColor: e.target.value})} className="w-12 h-12 rounded-xl bg-transparent border-none cursor-pointer" /><span className="text-xs font-mono font-bold uppercase">{settings.heroButtonColor}</span></div></div>
                </div>
